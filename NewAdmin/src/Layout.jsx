...
function Layout() {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div className="w-20 bg-gray-800 text-white p-4 sm:w-64 transition-all duration-300">
        <h1 className=" hidden sm:block text-2xl font-bold mb-8">Delivery Management</h1>
